...
def _get_embedding_fn():
    ...
    """
    # Option A: OpenAI (Ưu tiên vì đã có key trong .env)
    ...
    import random
    def embed(text: str) -> list:
        return [random.random() for _ in range(1536)] # match model dim
...
def _get_collection():
    ...
    try:
        ...
        print(f"⚠️  Collection 'day09_docs' chưa có data. Chạy index script trước.")
    return collection
