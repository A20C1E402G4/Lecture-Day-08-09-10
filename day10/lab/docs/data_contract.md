...
| Policy docs TXT/PDF (`data/docs/*.txt`) | Direct file read (Day 08 `index.py`) | OCR noise tạo ký tự rác, chunk rỗng sau parse, BOM prefix | `chunk_text_too_short` quarantine spike; `missing_chunk_text` trong quarantine |
